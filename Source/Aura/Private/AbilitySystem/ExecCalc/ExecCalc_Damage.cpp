...
void UExecCalc_Damage::Execute_Implementation(const FGameplayEffectCustomExecutionParameters &ExecutionParams, FGameplayEffectCustomExecutionOutput &OutExecutionOutput) const
{
    ...
    for (const TTuple<FGameplayTag, FGameplayTag> &Pair : FAuraGameplayTags::Get().DamageTypesToResistances)
    {
        ...
        {
            // override TakeDamage in AuraCharacterBase
            // create delegate OnDamageDelegate, brodcast damage received in TakeDamage
            // Bind to OnDamageDelegate on the victim here
            // Call UGameplayStatics::ApplyRadialDamageWithFalloff to cause damage (this will result in TakeDamage being called on the victim, which will then broadcast OnDamageDelegate)
